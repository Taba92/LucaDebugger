...
setupManualPanel(Parent) ->
  ...
  ForwSchButton = wxButton:new(ManuPanel, ?FORW_SCH_BUTTON,
                                [{label, "Sched"}]),
  ForwSigButton = wxButton:new(ManuPanel, ?FORW_SIG_BUTTON,
                                [{label, "Sig"}]),
  ...
  wxButton:disable(ForwSigButton),
  ...
  ref_add(?FORW_SIG_BUTTON, ForwSigButton),
  ...
  wxSizer:addSpacer(ForwardSizer, 5),
  wxSizer:add(ForwardSizer, ForwSigButton),
